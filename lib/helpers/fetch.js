...
exports.fetch = exports.buildFetchOpts = exports.buildFetchUrl = exports.HttpError = undefined;
...
var buildFetchUrl = exports.buildFetchUrl = function buildFetchUrl(_ref2) {
  var url = _ref2.url,
...
var buildFetchOpts = exports.buildFetchOpts = function buildFetchOpts(_ref3) {
  var context = _ref3.context,
      contextOpts = _ref3.contextOpts,
      actionOpts = _ref3.actionOpts;
  ...
  if (actionOpts.headers) {
    opts.headers = _extends({}, opts.headers, actionOpts.headers);
  }
...
var fetch = exports.fetch = function fetch(url) {
  ...
  var builtUrl = Object.keys(options.query || []).reduce(function (wipUrl, queryParam) {
    var queryParamValue = options.query[queryParam];
