...
var createActions = function createActions(_ref2) {
  ...
  return Object.keys(actions).reduce(function (actionFuncs, actionKey) {
    ...
    var actionUrl = action.url || defaultUrl;
    ...
    var actionFunc = function actionFunc(context) {
      ...
      return function (dispatch, getState) {
        ...
        var dynamicOpts = {};
        Object.keys(actionOpts).forEach(function (key) {
          if (typeof actionOpts[key] === 'function') {
            dynamicOpts[key] = actionOpts[key](getState);
          }
        });
        var fetchOptions = (0, _fetch.buildFetchOpts)({ context: context, contextOpts: contextOpts, actionOpts: Object.assign({}, actionOpts, dynamicOpts) });
        // d(`${name}Actions.${actionName}()`, fetchUrl, fetchOptions);
        return (0, _fetch2.default)(fetchUrl, fetchOptions).then((0, _transform.applyTransformPipeline)((0, _transform.buildTransformPipeline)(_defaults.defaultTransformResponsePipeline, actionOpts.transformResponse))).then(function (payload) {
